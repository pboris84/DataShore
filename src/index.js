...
if(varSelect){
    varSelect.addEventListener("change", function(){
        ...
        if(varSelect.value == "salinity") {
            varRequire.innerHTML = "<button type='button' class='mdl-chip' id='csvFileUpload' accept='.csv'><span class='mdl-chip__text'>Temperature</span></button> <button type='button' class='mdl-chip'><span class='mdl-chip__text'>Density</span></button> <input type='file' name='File Upload' id='txtFileUpload' accept='.csv'/>"
        }
        if(varSelect.value == "temperature") {
            varRequire.innerHTML = "<button type='button' class='mdl-chip' id='csvFileUpload' accept='.csv'><span class='mdl-chip__text'>Density</span></button> <button type='button' class='mdl-chip'><span class='mdl-chip__text'>Salinity</span></button> <input type='file' name='File Upload' id='txtFileUpload' accept='.csv'/>"
        }
        if(varSelect.value == "density") {
            varRequire.innerHTML = "<button type='button' class='mdl-chip' id='csvFileUpload' accept='.csv'><span class='mdl-chip__text'>Temperature</span></button> <button type='button' class='mdl-chip'><span class='mdl-chip__text'>salinity</span></button> <input type='file' name='File Upload' id='txtFileUpload' accept='.csv'/>"
        }
    });
}else{
    console.log("null")
...
d3.csv("/src/transactions.csv", function(error, data) {
  	window.data = data;
    console.log(data);
    ...
    Plotly.newPlot('file-upload',dataset1,layout1);
